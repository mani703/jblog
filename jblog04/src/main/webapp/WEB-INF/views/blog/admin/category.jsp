		      	...
		      	<table class="admin-cat">
		      		...
		      		<c:forEach items="${list }" var="vo" varStatus="status">
			      		<tr>
							...
							<td>${vo.count }</td>
							<td>${vo.desc }</td>
							<td><a href="${pageContext.request.contextPath }/${authUser.id}/${vo.no }/admin/category/delete"><img src="${pageContext.request.contextPath}/assets/images/delete.jpg"></a></td>
						</tr>
		      		</c:forEach>
				</table>
